...
<div class="outer-wrapper d-flex justify-content-center align-items-center hero-header position-relative">
    ...
    <div class="video-header-wrapper ">
        ...
        <video  loop="true" src="https://www.akoyaspabali.com/wp-content/uploads/2023/11/Akoya-.mp4" class="position-absolute top-0 start-0 w-100 h-100 object-cover"></video>
    ...
    <div class="container bg-transparent">
		...
		<div class="subtitle-wrapper text-center mt-5">
            ...
            <div class="btn-wrapper text-center">
                    ...
                    <a href="/treatments" style="padding: 10px 24px 10px 24px; background-color: #7e5230; border-radius: 6px; font-size: 17px; font-weight: 500; color:#ffffff;"><span style="margin-right: 10px;">Discover More</span> <img src="https://www.akoyaspabali.com/wp-content/uploads/2023/05/right_arrow.svg" alt="Dicover our treatments" width="12" height="9" class="img-fluid"></a>
    ...
    <div class="d-flex align-items-center flex-mobile-wrap" style="column-gap: 120px;">
        ...
        <div class="col-lg-7 col-12 order-0 order-lg-1 mb-5 mb-lg-0">
            ...
            <div class="btn-wrapper">
                ...
                <a href="<?= get_field('1_2-image-text')['button_link'] ? get_field('1_2-image-text')['button_link'] : '/treatments' ?>" style="padding: 10px 24px 10px 24px; background-color: #7e5230; border-radius: 6px; font-size: 17px; font-weight: 500; color:#ffffff;"><span style="margin-right: 10px;"><?= get_field('1_2-image-text')['button_text'] ? get_field('1_2-image-text')['button_text'] : 'Discover More' ?></span> <img src="https://www.akoyaspabali.com/wp-content/uploads/2023/05/right_arrow.svg" alt="Discover our spa" width="12" height="9" class="img-fluid"></a>
